"""Run the Monte-Carlo sim for every game and print an RTP / house-edge report.
Usage:  python report.py [--base N] [--seed HEX]"""
...
def main() -> None:
    ...
    print("-" * len(header))
    print(f"\nDone in {time.time() - start:.1f}s. RTP is measured over the real "
